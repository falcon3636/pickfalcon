    ...
    var methods = {
        ...
        init : function(options){
            return this.each(function() {
                ...
                // Set defaults
                var settings = {
                    'debug'            : 'true', // [true/false] Enable debugging
                    'groupReferenceIndicator' : 'contact_form', // [string] The #id or .class of the base group reference indicator.  e.g. .progressive_profiler_ (so each group in the HTML has a class of progressive_profiler_0, progressive_profiler_1, etc.)
                    'elementFieldGroups'    : ''
